...
import { OnboardingBanner } from '../components/StatusBanner'
    ...
    <div className={styles.container}>
      ...
      {clusters.length === 0 && (
        <div style={{ padding: '0 16px' }}>
          <OnboardingBanner title="Register edge clusters to populate the dashboard">
            Use the wizard below to register each edge cluster API endpoint and read-only credentials.
            The hub scraper will pull VulnerabilityReport and SbomReport CRs from registered clusters.
          </OnboardingBanner>
        </div>
      )}
