...
export interface AlertMatchers {
  package_name?: string | null
  version_expr?: string | null
  clusters: string[]
  namespace?: string | null
}

export interface AlertSlackReceiver {
  webhook_url: string
  channel?: string | null
  title?: string | null
}
...
export interface AlertPreviewMatch {
  cluster: string
  namespace: string
  name: string
  package: string
...
export interface AlertPreviewResult {
  items: AlertPreviewMatch[]
  total: number
  truncated: boolean
  scanned_reports: number
}

export interface AlertTestDeliveryResult {
...
export interface AlertTestResponse {
  ...
  total: number
  succeeded: number
  results: AlertTestDeliveryResult[]
}
