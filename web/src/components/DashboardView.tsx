  ...
  return (
    <section className="detail-container">
      ...
      <div ref={contentRef} className={styles.content}>
        ...
        {!loadError && !cluster && (statsData?.total_vuln_reports ?? 0) === 0 && (
          <OnboardingBanner title="No security data yet">
            Register edge clusters in Admin → Clusters. Reports appear after the hub scraper syncs Trivy Operator custom resources from each cluster.
          </OnboardingBanner>
        )}
