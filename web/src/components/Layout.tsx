...
export default function Layout() {
  ...
  return (
    <div className="app-shell">
      <Header version={version} stats={stats} />
      <main>
        <Outlet context={{ stats, clusterOptions, namespaceOptions, setFilterCluster }} />
      </main>
      <footer>
        <p>Trivy Viewer &mdash; Multi-cluster security report aggregator
          <span style={{ margin: '0 8px' }}>|</span>
          <a href="/api/v1/version" target="_blank" rel="noopener noreferrer">API</a>
        </p>
      </footer>
    </div>
  )
